            ...
            <section className="blog-section py-5">
                <div className="container">
                    ...
                    <div className="text-center mb-5">
                        <p className="small-text">FROM THE BLOG</p>
                        <h2 className="main-title">
                            Check Out Our <br /> Latest Posts
                        </h2>
                    </div>
                    ...
                    <div className="row g-4">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="blog-card">
                                <img src={require('./Routs/img/blog-1.jpg')} alt="" />

                                <div className="blog-content">
                                    <span>Oct 24, 2023 • Fashion</span>
                                    <h5>The Perfect Guide To Pick Your Perfect Duffle 2024!</h5>
                                    <p>
                                        Summer is here, the season of road trips, redeyes,
                                        and getaways is upon us...
                                    </p>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="blog-card">
                                <img src={require('./Routs/img/blog-2.jpg')} alt="" />

                                <div className="blog-content">
                                    <span>Oct 24, 2023 • Denim</span>
                                    <h5>Products With Purpose: What is Clean Denim?</h5>
                                    <p>
                                        Discover how sustainable denim improves product
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="blog-card">
                                <img src={require('./Routs/img/blog-3.jpg')} alt="" />

                                <div className="blog-content">
                                    <span>Oct 24, 2023 • Style</span>
                                    <h5>Gold Seal of Sustainability: GOTS Explained!</h5>
                                    <p>
                                        Learn why sustainable brands cost more and how
                                        ethical production impacts quality...
                                    </p>
                                    <button className="read-btn">Read More →</button>
                                </div>
                            </div>
