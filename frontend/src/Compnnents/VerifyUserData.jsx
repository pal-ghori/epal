...
const VerifyUserData = () => {
    ...
    //     console.log("RAZORPAY RESPONSE:", result.data);
    ...
    const result = await axios.post(
        `http://localhost:5000/checkout/createorderforallcart/${cartId}`
    );
    ...
    const options = {
        ...
        handler: async function (response) {
            axios.post(`http://localhost:5000/checkout/paymentvarification`, {
                ...
                razorpaySignature: response.razorpay_signature,
                userId: userid,
                arrayofproduct: orderData.arrayofproduct, // ✅ FIXED
                checkoutId: checkoutId
            })
            .then((res) => {
